...
namespace Complexity.Script
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                using (Application app = Application.CreateApplication("piyf","123456"))
                {
                    Execute(app);
                }
            }
        ...
        {
            PlanComplexity.Script.MyControl myControl = new PlanComplexity.Script.MyControl(app);
            myControl.ShowDialog();


            // Encoding.RegisterProvider(CodePagesEncodingProvider.Instance);
            // String outputdir = @"d:\PlanComplexity";
